...
select.addEventListener('change', () => {
    ...
    } else if (opcaoSelecionada === "Sobremesa") {
        tabelas[3].style.display = "block";
    } else if (opcaoSelecionada === "Molhos") {
        tabelas[4].style.display = "block";
    } else if (opcaoSelecionada === "Acompanhamento") {
        tabelas[2].style.display = "block";
    }
})
