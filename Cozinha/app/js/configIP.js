...
const confirmSave = () => {
    ...
    if (divSenha.style.display != 'block') {
        ...
        let result = confirm("Você deseja salvar as alteraões realizadas? (Em caso de alguma informação que não condiz com a realidade ou não está de acordo com o protocólo do empregado, o usuário será cabível de punições.)")
