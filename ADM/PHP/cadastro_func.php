...
if (($checar == 1) AND ($checar2 == 2) AND ($checar3 == 1) AND ($checar4 == 1)) {
        ...
        if($checar2 == 1){
            ...
            if($checar3 == 1){
                ...
                if($checar4 == 1){
                    ...
                    $sql->query("INSERT INTO funcionarios (id_tipo,nome,dta_nasc,sexo,dta_admissao,religiao,tipo_sanguineo,tel,tel_emergencia,ctps,pis,tit_eleitor,reservista,vr,vt,comissao,conta_bancaria,habilitado,email_adm,senha_adm) VALUES ('$carg_func','$nome_func','$dtNasc_funcf','$sexo_func','$adimi_funcf','$relig_func','$sang_func','$tel_func','$telEmer_func','$cart_func','$pis_func','$titu_func','$reser_func', $vaRef_func, $vaTra_func , $comi_func ,'$cBanc_func','$habi_func','$email_func','$senha')");
                    echo '<script>alert("Cadastro do funcionario  ' . $nome_func . ' realizado com sucesso, a senha do funcionario é o seu nome  ' . $nome_func . ', depois há possibilidade de alteração"); window.location.href = "../app/pagina-inicial/cadastro-de-funcionarios/cad_func.php";</script>';
                }
            }
        }
    }
    ...
    /*$sql->query("INSERT INTO funcionarios (id_tipo,nome,dta_nasc,sexo,dta_admissao,religiao,tipo_sanguineo,tel,tel_emergencia,ctps,pis,tit_eleitor,reservista,vr,vt,comissao,conta_bancaria,habilitado,email_adm,senha_adm) VALUES ('$carg_func','$nome_func','$dtNasc_funcf','$sexo_func','$adimi_funcf','$relig_func','$sang_func','$tel_func','$telEmer_func','$cart_func','$pis_func','$titu_func','$reser_func', $vaRef_func, $vaTra_func , $comi_func ,'$cBanc_func','$habi_func','$email_func','$senha')");
    echo '<script>alert("Cadastro do funcionario  ' . $nome_func . ' realizado com sucesso, a senha do funcionario é o seu nome  ' . $nome_func . ', depois há possibilidade de alteração");</script>';*/
    
    /*if (move_uploaded_file($_FILES['img']['tmp_name'],$uploaddir. $foto)){
