...
CREATE TABLE IF NOT EXISTS `acompanhamento` (
  ...
  `img` varchar(50) DEFAULT 'imgbd/acompanhamento/.jpg',
  `tipo` int DEFAULT '2',
  PRIMARY KEY (`id_acompanhamento`)
) ENGINE=InnoDB AUTO_INCREMENT=405 DEFAULT CHARSET=utf8mb3;

-- Copiando dados para a tabela cyber.acompanhamento: ~5 rows (aproximadamente)
INSERT IGNORE INTO `acompanhamento` (`id_acompanhamento`, `nome`, `preco`, `status`, `qtd`, `img`, `tipo`) VALUES
	(1, 'Nuggets', 20.00, 'ATIVO', NULL, 'acompanhamento/.jpg', 2),
	(2, 'Batata Frita com Cheddar e Bacon', 15.00, 'ATIVO', NULL, 'acompanhamento/.jpg', 2),
	(3, 'Batata Frita', 10.00, 'ATIVO', NULL, 'acompanhamento/.jpg', 2),
	(4, 'Onion Rings', 10.00, 'ATIVO', NULL, 'acompanhamento/.jpg', 2),
	(5, 'Nachos com Guacamole', 20.00, 'ATIVO', NULL, 'acompanhamento/.jpg', 2),
	(404, 'CANCELADO', 0.00, 'ATIVO', NULL, 'imgbd/acompanhamento/.jpg', 2);

-- Copiando estrutura para tabela cyber.banco_horas
CREATE TABLE IF NOT EXISTS `banco_horas` (
  ...
  KEY `id_func` (`id_func`),
  CONSTRAINT `banco_horas_ibfk_1` FOREIGN KEY (`id_func`) REFERENCES `funcionarios` (`id_func`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb3;

-- Copiando dados para a tabela cyber.banco_horas: ~5 rows (aproximadamente)
INSERT IGNORE INTO `banco_horas` (`id_banco`, `id_func`, `horas`, `mes`) VALUES
	(1, 12324, 25.00, '5'),
	(2, 12323, 15.00, '3'),
	(3, 12325, 30.00, '1'),
	(4, 12322, 10.00, '12'),
...
-- Copiando dados para a tabela cyber.bebida: ~17 rows (aproximadamente)
INSERT IGNORE INTO `bebida` (`id_bebida`, `nome`, `preco`, `qtd`, `status`, `img`) VALUES
	(1, 'Agua Natural', 2.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(2, 'Agua com Gãs', 2.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(3, 'Refrigerante Lata', 5.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(4, 'Refrigerante Garrafa de Vidro', 5.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(5, 'Suco Natural de Laranja', 7.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(6, 'Suco Natural de Morango', 7.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(7, 'Suco Natural de Uva', 7.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(8, 'Suco Natural de Limão', 7.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(9, 'Suco Natural de Maracuja', 7.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(10, 'Suco Natural de Goiaba', 7.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(11, 'MilkShake Morango', 10.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(12, 'MilkShake Chocolate', 10.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(13, 'MilkShake Caramelo', 10.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(14, 'MilkShake Ovomaltine', 10.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(15, 'MilkShake Chocomenta', 10.00, 1000, 'ATIVO', 'imgbd/beb/.jpg'),
	(16, 'Coca', 5.00, 1, 'ATIVO', 'imgbd/beb/Coca.png'),
	(17, 'Coca Cola II', 98.65, 6, 'ATIVO', 'imgbd/beb/Coca Cola II.png'),
	(404, 'CANCELADO', 0.00, 1000000, 'ATIVO', 'img/beb/.jpg');
...
-- Copiando dados para a tabela cyber.burguer: ~7 rows (aproximadamente)
INSERT IGNORE INTO `burguer` (`id_burguer`, `nome`, `preco`, `status`, `qtd`, `img`) VALUES
	(1, 'Dark Burguer', 25.00, 'ATIVO', NULL, 'imgbd/burguer/.jpg'),
	(2, 'BurguerCraft', 32.00, 'ATIVO', NULL, 'imgbd/burguer/.jpg'),
	(3, 'GarticBurguer', 27.00, 'ATIVO', NULL, 'imgbd/burguer/.jpg'),
	(4, 'SimsBurguer', 25.00, 'ATIVO', NULL, 'imgbd/burguer/.jpg'),
	(5, 'Super Mario Burguer 2', 27.00, 'ATIVO', NULL, 'imgbd/burguer/.jpg'),
	(8, 'Isaburguer', 65.00, 'ATIVO', 16, 'imgbd/burguer/Isaburguer.png'),
	(9, 'FelixBurguerII', 51.65, 'ATIVO', 6, 'imgbd/burguer/FelixBurguerII.png'),
	(404, 'CANCELADO', 0.00, 'ATIVO', NULL, NULL);
...
-- Copiando dados para a tabela cyber.cliente: ~4 rows (aproximadamente)
INSERT IGNORE INTO `cliente` (`id_cli`, `cpf_cli`, `nome`, `sexo`, `tel`, `dta_nasc`, `endereco`, `email_cli`, `dta_cadastro`, `senha_cli`) VALUES
	(1234, '206.301.148-62', 'Liz Lorena Marcia Porto', 'Feminino', '11 99584-9696', '2000-05-14', 'Rua dos Capitaes Generais, 123 - Mooca', 'liz_lorena_porto@plastic.com.br', '2022-08-05', 'FrhsiTtPL7'),
	(1235, '119.148.818-77', 'Juliana Malu Alessandra Ramos', 'Feminino', '11 98917-1846', '1999-09-12', 'Rua da Matriz, 699 - Santo Amaro', 'julianamaluramos@buzatto.pro', '2020-02-15', '654#21F'),
	(1236, '122.738.158-16', 'Renan Lopes', 'Masculino', '11 99847-2524', '1989-12-12', 'Rua dos Poostes, 12 - Vila Ponte Rasa', 'renan_lopes@gmail.com', '2020-03-03', 'renan12GE'),
	(1239, '561.516.165-15', 'GABRIEL FELIX DE OLIVEIRA', 'Masculino', '(46)16505-1650', NULL, 'Rua JoÃ£o Fioravante, 52 - Jardim Copacabana , SÃ£o Paulo', 'gf202240@gmail.com', '2023-10-22', 'NTYxLjUxNi4xNjUtMTU=');
...
-- Copiando dados para a tabela cyber.codigos: ~4 rows (aproximadamente)
INSERT IGNORE INTO `codigos` (`codigo_desconto`, `descricao`, `valor_descontado`, `estado`) VALUES
...
INSERT IGNORE INTO `comandas` (`comanda`, `mesa`) VALUES
	(103, 2),
	(104, 2),
	(105, 3),
	(106, 3),
...
INSERT IGNORE INTO `fornecedor` (`cnpj`, `nome`, `tel`, `tipo`) VALUES
...
CREATE TABLE IF NOT EXISTS `funcionarios` (
  ...
  `nome` varchar(255) NOT NULL,
  `cpf_func` char(14) NOT NULL DEFAULT '000.000.000-00',
  ...
  `tel_emergencia` char(13) NOT NULL,
...
INSERT IGNORE INTO `funcionarios` (`id_func`, `id_tipo`, `nome`, `cpf_func`, `dta_nasc`, `sexo`, `dta_admissao`, `dta_demissao`, `religiao`, `tipo_sanguineo`, `tel`, `tel_emergencia`, `ctps`, `pis`, `tit_eleitor`, `reservista`, `vr`, `vt`, `comissao`, `conta_bancaria`, `habilitado`, `email_adm`, `senha_adm`, `avatar`) VALUES
	(12321, 2, 'João Tomas Rocha', '123.456.789-98', '1983-08-05', 'Masculino', '2013-08-05', NULL, 'Catolico', 'A+', '(11) 11111-11', '11 95498-7456', '12345678/01', '123.45678.90-1', '1234.5678.9012', 'SIM', 422.40, 150.08, 0.10, '123169', 'SIM', 'jao@gmail.com', '123456', 'avatar/12321.jpg'),
...
-- Copiando estrutura para tabela cyber.hora_extra
CREATE TABLE IF NOT EXISTS `hora_extra` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_tipo` int NOT NULL,
  `id_banco` int NOT NULL,
  `id_func` int NOT NULL,
  `valor_extra` float(10,2) NOT NULL,
  `porcentagem` float(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_tipo` (`id_tipo`),
  KEY `id_banco` (`id_banco`),
  KEY `id_func` (`id_func`),
  CONSTRAINT `hora_extra_ibfk_1` FOREIGN KEY (`id_tipo`) REFERENCES `tipo` (`id_tipo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `hora_extra_ibfk_2` FOREIGN KEY (`id_banco`) REFERENCES `banco_horas` (`id_banco`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `hora_extra_ibfk_3` FOREIGN KEY (`id_func`) REFERENCES `funcionarios` (`id_func`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb3;

-- Copiando dados para a tabela cyber.hora_extra: ~0 rows (aproximadamente)
INSERT IGNORE INTO `hora_extra` (`id`, `id_tipo`, `id_banco`, `id_func`, `valor_extra`, `porcentagem`) VALUES
	(77, 2, 1, 12321, 12.47, 0.70);
...
CREATE TABLE IF NOT EXISTS `mesas` (
  ...
  `chamando` char(3) DEFAULT NULL,
  PRIMARY KEY (`mesa`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb3;

-- Copiando dados para a tabela cyber.mesas: ~8 rows (aproximadamente)
INSERT IGNORE INTO `mesas` (`mesa`, `qtdCadeiras`, `estado`, `chamando`) VALUES
	(1, 10, 'Livre', 'nao'),
	(2, 2, 'Livre', 'não'),
	(3, 4, 'Ocupada', 'não'),
	(4, 4, 'Livre', 'não'),
...
-- Copiando dados para a tabela cyber.molho: ~7 rows (aproximadamente)
INSERT IGNORE INTO `molho` (`id_molho`, `nome`, `qtd`, `status`, `img`) VALUES
	(1, 'Barbecue', 1000, 'ATIVO', 'molho/.jpg'),
	(2, 'Rose', 1000, 'ATIVO', 'molho/.jpg'),
	(3, 'Tomate Picante', 1000, 'ATIVO', 'molho/.jpg'),
	(4, 'Tartaro', 1000, 'ATIVO', 'molho/.jpg'),
	(5, 'Guacamole', 1000, 'ATIVO', 'molho/.jpg'),
	(6, 'MSEGREDO', 1000, 'ATIVO', 'molho/.jpg'),
	(7, 'Molho de Mostarda com Mel', 1000, 'ATIVO', 'molho/.jpg'),
	(404, 'CANCELADO', 1000000, 'ATIVO', NULL);
...
INSERT IGNORE INTO `objeto_fornecido` (`lote`, `cnpj`, `preco_unidade`, `qtd`, `nota_fiscal`, `data`) VALUES
...
CREATE TABLE IF NOT EXISTS `pedidos` (
  ...
  `obs` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
-- Copiando dados para a tabela cyber.pedidos: ~19 rows (aproximadamente)
INSERT IGNORE INTO `pedidos` (`id`, `mesa`, `comanda`, `id_burguer`, `qtd`, `id_bebida`, `qtdbeb`, `id_acompanhamento`, `qtdacomp`, `id_molho`, `qtdmolho`, `id_sobremesa`, `qtdsobremesa`, `obs`, `horaPedido`, `situacao`) VALUES
...
-- Copiando dados para a tabela cyber.produto: ~5 rows (aproximadamente)
INSERT IGNORE INTO `produto` (`id_prod`, `lote`, `tipo`, `prod`, `preco_compra`, `preco_venda`, `qtd`, `dta_compra`, `dta_vencimento`, `status`, `img`) VALUES
	(1, 1, 'Bebida', 'Agua Natural 5000ml', 6.89, 8.80, 60, '2023-08-05', '2023-08-05', 'ATIVO', 'imgbd/prod/1.png'),
	(2, 2, 'Bebida', 'Agua com Gas 500ml', 23.79, 25.68, 20, '2023-08-08', '2023-10-05', 'ATIVO', 'imgbd/prod/2.jpg'),
	(3, 3, 'Carnes', 'Carne Moida 3Kg', 45.65, 50.00, 15, '2023-07-31', '2023-08-04', 'ATIVO', 'imgbd/prod/3.png'),
...
-- Copiando dados para a tabela cyber.sobremesa: ~7 rows (aproximadamente)
INSERT IGNORE INTO `sobremesa` (`id_sobremesa`, `nome`, `preco`, `status`, `img`) VALUES
...
INSERT IGNORE INTO `tipo` (`id_tipo`, `cargo`, `sal_hora`, `carga_horaria`, `salario`) VALUES
...
-- Copiando dados para a tabela cyber.venda: ~7 rows (aproximadamente)
INSERT IGNORE INTO `venda` (`id_venda`, `id`, `id_func`, `id_cli`, `data`, `codigo_desconto`, `forma_pagamento`, `desconto`, `taxa_servico`, `situacao`, `valor_total`) VALUES
