...
if($dados->num_rows > 0){ //verificamos se o numero de linhas é maior que 0
    ...
    if($checar == 1){ //se for existente, joga para a pagina de informações pessoais 
        echo '<script>alert("Informações confirmadas com sucesso!"); window.location.href = "../app/configuracoes/informacoes-pessoais/configuracoes.php ";</script>';
    }else{ //caso não, joga para a pagina anterior ../app/configuracoes/informacoes-pessoais/configuracoes.php 
        echo '<script>alert("email e/ou senha digirados errados!, confirme suas credenciais!"); window.location.href = "../app/configuracoes/informacoes.php";</script>';
